	...
	<section id="content">
		...
		<main>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <form method="POST" action="svMingguan.php" class="form" enctype="multipart/form-data">
                            <div class="form-group">
                                <h1>Pemeliharaan Mingguan</h1>
        ...
        // Fungsi untuk memeriksa apakah tanggal yang dimasukkan valid (7, 14, 21, atau 28 setiap bulan)
        function isValidDate(date) {
            const inputDate = new Date(date);
            const dayOfMonth = inputDate.getDate();

            // Tanggal yang valid adalah 7, 14, 21, atau 28 setiap bulan
            const validDays = [7, 14, 21, 28];

            return validDays.includes(dayOfMonth);
        }
        ...
        tanggalInput.addEventListener("change", function () {
            ...
            if (!isValidDate(inputValue)) {
                alert("Tanggal yang valid adalah 7, 14, 21, atau 28 setiap bulan.");
                tanggalInput.value = ""; // Mengosongkan input jika tanggal tidak valid
            }
        });
    </script>

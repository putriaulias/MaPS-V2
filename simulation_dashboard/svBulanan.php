<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = "SELECT COUNT(*) as total_kegiatan FROM kegiatan WHERE id_alat = (SELECT id_alat FROM alat WHERE id_alat = '$selectedAlat') AND id_alat IN (SELECT id_alat FROM merk WHERE id_merk = '$selectedMerk') AND tipe_keg = 3";
        ...
        $sql = "INSERT INTO ck_bulan (id_alat, id_merk , tanggal, status, persen, keterangan) VALUES ('$selectedAlat','$selectedMerk', '$tanggal', '$status', '$persentase_progres', '$keterangan')";

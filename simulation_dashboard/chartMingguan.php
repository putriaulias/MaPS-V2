...
<body>
    ...
    <section id="content">
        <main>
            <div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active" href="chartMingguan.php">Chart Mingguan</a>
						</li>
					</ul>
				</div>
			</div>
            <div class="persen">
                ...
                <div class="head">
                    ...
                    <div class="container" id="containerMingguan" style="display: none;">
                        <?php
                            $mysqli = new mysqli("localhost", "root", "", "logbook");
                        ...
                        <div class="float-start">
                            <p>Nama Alat: <?php echo $nama_alat; ?></p>
                            <p>Nama Merk: <?php echo $nama_merk; ?></p>
                        </div>
                        <!-- Tabel Persentase Harian -->
                        <h2 id="mingguan">Persentase Mingguan</h2>
                        <a href="addMingguan.php" class="btn btn-primary float-end float-end">
                            <i class='bx bxs-plus-circle'></i>
                            <span class="text">Tambah Data</span>
                        </a>
                        <br>
                        <br>
                        <table id="tabelMingguan" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>Tanggal</th>
                                    <th>Keterangan</th>
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    if (!empty($id_alat)) {
                                        ...
                                        $sql = "SELECT * FROM ck_minggu WHERE id_alat = '$id_alat' AND id_merk = '$id_merk' ORDER BY tanggal ASC";
                                    } else {
                                        // Jika ID alat tidak diisi, ambil semua data
                                        // $sql = "SELECT * FROM ck_minggu ORDER BY tanggal ASC";
                                    }
        ...
        <!-- Script Gauge -->
        <script>
        // Ambil data persentase dari tabel mingguan
            var data = [];
            var labels = [];
                    
            // Loop melalui baris tabel harian (untuk mengambil data)
            $("#tabelMingguan tbody tr").each(function () {
            ...
            var rataRataPersentase2 = Math.round(totalPersentase / data.length);

            // var judulGrafik2 = 'Persentase Dalam 1 Bulan';
            var judulGrafik2 = 'Persentase Kesiapan Alat (Mingguan)';
            ...
            Highcharts.chart('gauge2', {
                ...
                series: [{
                    ...
                    data: [rataRataPersentase2], // Tampilkan persentase kinerja dari data
                    dataLabels: {
                        format: '{y} %',
                        borderWidth: 0,
                        style: {
        ...
        <script>
            ...
            // Memeriksa persentase mingguan dan menampilkan alert jika <= 80
            $(document).ready(function () {
                $("#tabelMingguan tbody tr").each(function () {
                    var persentase = parseFloat($(this).find(".progress-bar").attr("aria-valuenow"));
                    if (persentase <= 80) {
            ...
            function showAlert(message, tableRow) {
                ...
                var catatan = $(tableRow).find("td:nth-child(3)").text().trim();

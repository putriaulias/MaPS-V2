...
<body>
        ...
        <main>
            <div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active" href="chartBulanan.php">Chart Bulanan</a>
						</li>
					</ul>
				</div>
			</div>
            <div class="persen">
                ...
                <div class="head">
                    ...
                    <div class="container" style="max-width: auto; margin-top: 50px;">
                        <div class="row">
                            <div class="col">
                                ...
                                <button id="toggleBulanan" class="btn btn-primary float-end" style="background: none; border: none;">
                    ...
                    <div class="container" id="containerBulanan" style="display: none;">
                        <?php
                            $mysqli = new mysqli("localhost", "root", "", "logbook");
                        ...
                        <h2 id="harian">Persentase Bulanan</h2>
                        <a href="addBulanan.php" class="btn btn-primary float-end float-end">
                            <i class='bx bxs-plus-circle'></i>
                            <span class="text">Tambah Data</span>
                        </a>
                        <br>
                        <br>
                        <table id="tabelBulanan" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>Bulan</th>
                                    <th>Keterangan</th>
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    if (!empty($id_alat)) {
                                        ...
                                        $sql = "SELECT * FROM ck_bulan WHERE id_alat = '$id_alat' AND id_merk = '$id_merk' ORDER BY tanggal ASC";
                                    } else {
                                        // Jika ID alat tidak diisi, ambil semua data
                                        // $sql = "SELECT * FROM ck_bulan ORDER BY tanggal ASC";
                                    }
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#toggleBulanan").addClass("active");
            $("#toggleBulanan").click(function() {
                $("#containerBulanan").slideToggle();
            });
        });
    ...
    <script>
        ...
        $("#tabelBulanan tbody tr").each(function () {
        ...
        var judulGrafik = 'Persentase Kesiapan Alat (Bulanan)'
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#tabelBulanan tbody tr").each(function () {
                ...
                if (persentase <= 80) {
                    var tanggal = $(this).find("td:first-child").text().trim();
                    var alertMessage = "Warning! Persentase alat pada bulan " + tanggal + " kurang dari 80 %";
